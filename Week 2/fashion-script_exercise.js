...
function getModel() {
    ...
    model.add(tf.layers.conv2d({filters: 16, inputShape: [28, 28, 1], kernelSize: 3, activation: 'relu'}));
...
async function train(model, data) {
    ...
    const metrics = ["accuracy", "val_accuracy", "loss", "val_loss"] // YOUR CODE HERE    

        
    // Create the container for the callback. Set the name to 'Model Training' and 
    // use a height of 1000px for the styles. 
    const container = {name: "Training The Model", styles: {height: '640px'}}// YOUR CODE HERE   
